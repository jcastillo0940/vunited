...
@section('content')
    <div style="display:flex;justify-content:space-between;align-items:flex-end;gap:1rem;flex-wrap:wrap;">
        <div>
            <h2 style="margin:0 0 0.4rem;">Store Orders</h2>
            <p style="margin:0;color:#475569;">Readonly monitoring for store orders paid through PayPal.</p>
        </div>
    </div>
            ...
            <tbody>
                @forelse ($orders as $order)
                    <tr style="border-bottom:1px solid #eef2f7;">
                        ...
                        <td style="padding:0.75rem;"><a href="{{ route('admin.store-orders.show', $order) }}">View</a></td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" style="padding:1rem;">No store orders found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
