...
@section('content')
    <section>
        <h2 style="margin-top: 0;">Create News Article</h2>

        <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data" style="display: grid; gap: 1rem;">
            @csrf
            ...
            <label style="display: grid; gap: 0.35rem;">
                ...
                <input type="text" name="featured_image_path" value="{{ old('featured_image_path') }}">
            </label>
